...
public class CustomSnapTurn : LocomotionProvider
{
    [SerializeField]
    ...
    [SerializeField]
    [Tooltip("Controls whether to enable 180Åã snap turns.")]
    bool m_EnableTurnAround = true;
    /// <summary>
    /// Controls whether to enable 180Åã snap turns.
    /// </summary>
    ...
    protected virtual float GetTurnAmount(Vector2 input)
    {
        ...
        switch (cardinal)
        {
            ...
            case Cardinal.South:
                ...
                {
                    playerController.targetRotationUpdate(180f);
                    return 180f;
                }
                break;
            case Cardinal.East:
                ...
                {
                    playerController.targetRotationUpdate(m_TurnAmount);
                    return m_TurnAmount;
                }
                break;
            case Cardinal.West:
