...
public class OldCustomGravity : LocomotionProvider
{
    [SerializeField]
    ...
    protected virtual bool TryProcessGravity(float time)
    {
        ...
        {
            m_CurrentFallVelocity = Vector3.ClampMagnitude(m_CurrentFallVelocity + (m_GravityAccelerationModifier * time * gravityForce), m_TerminalVelocity);
        }
