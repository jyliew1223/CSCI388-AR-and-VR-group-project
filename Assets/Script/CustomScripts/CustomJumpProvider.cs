...
public class CustomJumpProvider : LocomotionProvider, IGravityController
{
    [SerializeField]
    ...
    /// </summary>
    [SerializeField] private CustomGravityProvider m_GravityProvider;
    ...
    {
        base.Awake();
        m_HasGravityProvider = m_GravityProvider != null;
    ...
    public void Jump()
    {
        ...
        if (rotateBool)
        {
            // Rotate gravity instead of jumping
            m_GravityProvider.RotateGravity();
        }

        if (flipBool)
        {
            // Flip gravity instead of jumping
            m_GravityProvider.InvertGravity();
        }
    ...
    public void boolSwap(string boolName)
    {
        if(boolName == "rotateBool" || boolName == "rb")
        {
            rotateBool = true;
            flipBool = false;
        }
        else if (boolName == "flipBool" || boolName == "fb")
        {
            rotateBool = false;
            flipBool = true;
        }
